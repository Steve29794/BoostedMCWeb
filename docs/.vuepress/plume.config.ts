...
import { chineseNavbar } from './navbar'
import { chineseNotes } from './notes'
...
export default defineThemeConfig({
  ...
  /* 站点页脚 */
  footer: {
    message: 'Made by Steve29794 with ♥ and powered by VuePress',
    copyright: 'Copyright© 2024 BoostedMC',
  },
